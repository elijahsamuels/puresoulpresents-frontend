...
function UserName2(props) {
  // console.log("UserName2 preloadedValues: ", preloadedValues);
  // console.log("UserName2 props.user: ", props.user);
...
const mapStateToProps = (state) => {
  console.log("UserName2 state: ", state);
  return {
...
export default connect(mapStateToProps, { fetchUserData, editUser })(UserName2);
